...
![Main design configuration](config_tcl.png)
...
![Sky130 standard-cell configuration](sky130A_sky130_fd_sc_hd_config_tcl.png)
...
![Floorplanning configuration options](floorplan_configuration.png)
...
![Floorplan Tcl configuration](floorplan_tcl.png)
...
![Generated floorplan DEF](floorplan_def.png)
...
![I/O placer log](ioPlacer_log.png)
...
![Initial floorplan layout](< layout1.png>)
...
![Floorplan I/O and boundary details](< layout2.png>)
...
![Initial standard-cell placement](placement1.png)
...
![Detailed placement region](placement2.png)
